  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className="absolute z-[3] -left-[50%] top-0 w-[60%] h-[30%] rounded-full white__gradient" />
        <div className="absolute z-[0] -left-[50%] bottom-0 w-[60%] h-[30%] rounded-full pink__gradient" />
      </div>
